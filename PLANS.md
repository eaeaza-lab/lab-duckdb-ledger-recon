...
- [ ] **M1 synthetic ledgers** *(mvp)* — Add deterministic synthetic sales, payments, invoices, and tax-ledger generators with documented discrepancies. Acceptance: `ledger-recon generate --seed 42 --output tmp/data`
